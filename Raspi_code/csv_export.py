...
csv_file_path = '/home/ryan/Desktop/test/pos_test_3.csv'

# Create a CSV file to store the data
with open(csv_file_path, 'w', newline='') as csvfile:
    csvwriter = csv.writer(csvfile)
    csvwriter.writerow(['Time', 'Center_X', 'Center_Y'])
    ...
    while True:
        ...
        if current_time - last_save_time >= 0.066:  
            elapsed_time = current_time - start_time
            csvwriter.writerow([elapsed_time, centroid_x, centroid_y])
